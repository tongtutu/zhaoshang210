...
class UserMenuController extends \bagesoft\common\controllers\admin\Base
{
    /**
     * 列表
     */
    ...
    {
        parent::acl();
        $model = UserMenu::find()->orderBy('lft ASC')->all();
        //两个循环而已，没有递归
        $parent = [];
        $datalist = [];
    ...
    public function actionState()
    {
        try {
            ...
            if (is_array($id)) {
                UserMenu::updateAll(['state' => $type == 1 ? 1 : 2], ['in', 'id', $id]);
            } else {
