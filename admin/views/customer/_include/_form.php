                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <?php echo $form->field($model, 'sex')->dropDownList(System::SEX); ?>
                            </div>
                            <div class="col-lg-3">
                                <?php echo $form->field($model, 'job_title')->textInput(['maxlength' => true]); ?>
                            </div>
                            <div class="col-lg-3">
                                <?php echo $form->field($model, 'stars', [])->dropDownList(System::STARS); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
                                <?php echo $form->field($model, 'phone', ['inputOptions' => ['class' => 'form-control ' . $inputAddon, 'data-field' => 'phone']])->textInput(['maxlength' => true]); ?>
                            </div>
                            <div class="col-lg-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <?php echo $form->field($model, 'partner_uid')->widget(Select2::className(), [
                                    'data' => UserFunc::getPartners(0),
                                    'options' => ['placeholder' => '选择伙伴'],
                                    'pluginOptions' => [
                                        'allowClear' => true,
                                    ],
                                ]); ?>
