                        ...
                        <div class="col-12 table-responsive">
                            <table class="table table-">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>客户姓名:</th>
                                        <td><?php echo Html::encode(ProjectFunc::adminHideName($this->context->admin, $model->realname)); ?>
                                            <?php echo System::STARS[$model->stars]; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>联系方式:</th>
                                        <td><?php echo Html::encode(ProjectFunc::adminHidePhone($this->context->admin, $model->phone)); ?><br><?php echo Html::encode(ProjectFunc::adminHidePhone($this->context->admin, $model->phone1)); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>联系地址:</th>
                ...
                <div class="col-12 table-responsive">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                <th>状态</th>
                                <td><?php echo UserConst::STATUS[$partner->state]; ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
