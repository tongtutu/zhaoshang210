...
<head>
    ...
    <title><?php echo Html::encode($this->title); ?>- ADMIN</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <?php $this->head(); ?>
</head>

<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed pace-blue">
    <?php $this->beginBody(); ?>
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown"> <a class="nav-link " data-toggle="dropdown" href="#"> <i
                            class="fas fa-user"> <?php echo Html::encode($this->context->admin->username); ?> </i> <span
                            class="fas fa-bars"></span> </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <div class="dropdown-divider"></div>
                        <a href="<?php echo Url::to(['home/data']); ?>" class="dropdown-item" title="我的资料"><i
                                class="fas fa-id-card mr-2"></i> 我的资料 </a>
                        <div class="dropdown-divider"></div>
                        <a href="<?php echo Url::to(['public/logout']); ?>" class="dropdown-item" title="退出系统"><i
                            ...
                            <?php echo date('Y-m-d H:i:s', $this->context->admin->last_login_at); ?></span>
                    </div>
                </li>
            </ul>
        </nav>
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="<?php echo Url::to(['site/index']); ?>" class="brand-link"> <img
                    src="<?php echo Yii::$app->params['res.url']; ?>/static/admin/img/AdminLTELogo.png"
                    alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> <span
                    class="brand-text font-weight-light">旗联云-后台</span> </a>
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        data-accordion="false">
                        <?php foreach (\bagesoft\models\AdminMenu::tree($this->context->accessList) as $key => $tree): ?>
                            ...
                            <li class="nav-item has-treeview <?php if ($isopen): ?> menu-open<?php endif; ?>"> <a
    ...
    <div class="float-right d-none d-sm-block"> <b>Version</b> 5.0.0 </div>
    <strong>Copyright &copy; 2014-2020 <a href="https://cookman.cn">BageCMS.COM</a>.</strong> All rights
    reserved. </footer> -->
