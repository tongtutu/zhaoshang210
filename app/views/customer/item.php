...
<div class="row">
    <div class="col-lg-9">
                        ...
                        <div class="col-12 table-responsive">
                            <table class="table table-">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>联系方式</th>
                                        <td><?php echo Html::encode(ProjectFunc::hidePhone($model->uid, $this->context->user->id, $model->phone)); ?><?php if ($model->phone1): ?>，<?php echo Html::encode(ProjectFunc::hidePhone($model->uid, $this->context->user->id, $model->phone1)); ?><?php endif ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>联系地址</th>
        ...
        <?php if ($model->partner_accept == System::APPROVE): ?>
            <?php if ($isBtManager): ?>
                <?php echo $this->render('/_include/btMgrMaintainForm', [
                    'maintain' => $maintain,
                    'model' => $model,
