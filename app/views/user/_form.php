        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php echo $form->field($model, 'password')->passwordInput(['maxlength' => true]) ?> </div>
                </div>
                <div class="row">
                    <div class="col-md-4"> <?php echo $form->field($model, 'email')->textInput(['maxlength' => true]) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <?php echo $form->field($model, 'sex')->dropDownlist(['1' => '男', '2' => '女']) ?> </div>
                </div>
                <?php echo $form->field($model, 'intro', ['template' => "{label}\n<div class=\"row\">\n<div class=\"col-md-8\">{input}\n</div>\n</div>\n<div>{error}</div>"])->textarea(['rows' => 6]) ?>
                <?php echo $form->field($model, 'intro_admin', ['template' => "{label}\n<div class=\"row\">\n<div class=\"col-md-8\">{input}\n</div>\n</div>\n<div>{error}</div>"])->textarea(['rows' => 6]) ?>
                <?php if (!$model->isNewRecord): ?>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
