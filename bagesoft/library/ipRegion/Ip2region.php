...
class Ip2region extends \yii\base\Object
{
    /**
     * db file handler
     */
    ...
    private $dbFile = __DIR__ . DIRECTORY_SEPARATOR . 'ip2region' . DIRECTORY_SEPARATOR . 'ip2region.db';
    ...
    {
        try {
            $result = $this->btreeSearch($ip);
            $result = str_replace(['省', '市'], '', $result['region']);
